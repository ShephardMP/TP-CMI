...
class Ventana_principal:
    ...
    def __init__(self, top=None,adminInterfaz=None):
        ...
        top.title("Analizador de datos por clustering")
        ...
        self._img5 = PhotoImage(file=os.path.join(THIS_FOLDER,"./resources/guardarTabla.png"))
        self.guardarTabla.configure(image=self._img5)
